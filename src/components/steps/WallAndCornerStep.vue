<template>
  <div class="step-content">
    <StepHeader
      :icon="stepIcon"
      :title="store.nextWallTitle"
      :subtitle="store.nextWallSubtitle"
    />
    ...
    <InputField
      ...
      :hasError="store.errors.nextWall"
...
onMounted(() => {
  svgStore.drawWallAndCornerPreview(
    store.walls,
    store.corners,
    parseFloat(store.inputs.nextWall) || null,
